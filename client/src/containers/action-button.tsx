...
// Enables the user to add or remove a trip from their cart.
// It doesn't execute any GraphQL operations, because it can instead
// interact directly with the cartItemsVar reactive variable.
